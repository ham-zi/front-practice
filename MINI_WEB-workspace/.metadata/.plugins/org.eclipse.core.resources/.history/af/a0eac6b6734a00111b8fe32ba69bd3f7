...
<body>
    ...
    <div id="wrap">
        <header>
            <div id="header_1">
                <a href="#" id="logo_1">햇살<span id="logo_2">마켓</span></a>
            </div>
                ...
                <div id="util">
                	...
                	<c:choose>
					    <c:when test="${empty userInfo}">
		                	<form method="post" action="http://www.localhost:8088/market/login_page.do">
		                    	<button type="submit">로그인</button>
		                	</form>
		                	<form method="post" action="http://www.localhost:8088/market/enroll.do">
