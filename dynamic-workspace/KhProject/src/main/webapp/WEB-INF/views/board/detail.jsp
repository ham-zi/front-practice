		          ...
		          <div class="form-group">
		            <label>첨부파일</label>
							...
							<c:choose>
								...
								<img style="width:80%;" src="${ attachment.filePath }/${ attachment.changeName }"/>							
								<a
									download="${attachment.originName }"
									href="${ attachemnt.filePath }/${ attachment.changeName }"
	    		...
	    		$.ajax({
	    			...
	    			success : result => {
	    				...
	    				if(result.code === '201'){
	    					...
	    					document.querySelector('#replyContent').vlaue = '';
	    					selectReply();
	    				}
